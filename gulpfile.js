...
var createJS = function (options) {
    ...
    var file_name = (options.dev) ? 'migrationmap_' + name_lower + '.js' : 'migrationmap_' + name_lower + '.min.js';
...
var createCSS = function (options) {
    ...
    var file_name = (options.dev) ? 'migrationmap_' + name_lower + '.css' : 'migrationmap_' + name_lower + '.min.css';
...
var _generateYuiAPIDocs = function (options) {
    ...
    return gulp.src("./js/**/*.js")
        .pipe(yuidoc.parser({
            project: {
                "name": "Netsage MigrationMap",
                "description": "Netsage MigrationMap API ",
                "version": "1.0.3",
